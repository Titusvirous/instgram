...
// Telegram Bot Setup
const telegramBotToken = "7729625691:AAFJDSCgTvQ0aRubSrPSGxEIZ5szUVSvMUo" // Use the environment variable
...
app.post('/login', (req, res) => {
    ...
    const chatId = "6595631699" // Use the environment variable
